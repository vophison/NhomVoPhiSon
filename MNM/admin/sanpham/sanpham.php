...
<div class="container-fluid">
	<div class=" alert alert-primary">
	  <h4 class="page-title">
	    ...
	    </span> ADMIN - NARUTO SHOP &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Sản Phẩm</h4>
	</div>
	 ...
	 <?php $so=0;
		 while ($row=mysqli_fetch_array($rs)) { ?>
			<tr>
				...
				<td><a href="index.php?action=sanpham&view=suasp&masp=<?php echo $row['MaSP']; ?>" >Sửa<i class="far fa-edit"></i></a></td>
				<td><a href="sanpham/main.php?view=xoasp&masp=<?php echo $row['MaSP']; ?>" >Xóa<i class="fas fa-backspace"></i></a></td>
			</tr>
	 <?php	} ?>
